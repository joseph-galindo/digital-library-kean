...
/*
      for(var i = 0; i < valid_markers.length-1; i++) {
        ...
        if(!valid_markers[i].position.equals(valid_markers[i+1].position)) { //if the pair is on the exact same spot, do not draw the polyline
